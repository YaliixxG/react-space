...
class Navbar extends Component {
    ...
    render() {
        ...
        this.readData.map(item => {
            return readArr.push(
                <div
                    className="artical-read"
                    key={item.id}
                    onClick={() => this.go(item.book.alt)}
                >
        ...
        this.movieData.map(item => {
            return movieArr.push(
                <div
                    className="artical-movie"
                    key={item.id}
                    onClick={() => this.go(item.alt)}
                >
        ...
        this.newsData.map(item => {
            return newsArr.push(
                <div className="artical-news" key={item.id}>
        ...
        this.musicData.map(item => {
            return musicArr.push(
                <div className="artical-music">
                    <span className="cont">
                        TOP:
                        {item.cur_count}
                    </span>
